...
def plot_models(x, y, models, fname, mx=None, ymax=None, xmin=None):
    ...
    if models:
        ...
        for model, style, color in zip(models, linestyles, colors):
            ...
            # se definen las caracteristicas de la pendiente. 
            plt.plot(mx, model(mx), linestyle=style, linewidth=2, c=color)
            # se ubica en la parte superior izquierda la variable d con su respectivo valor
        plt.legend(["d=%i" % m.order for m in models], loc="upper left")
    #se acopla la grafica con los valores maximos de y and x, y se guarda en una nueva imagen 
